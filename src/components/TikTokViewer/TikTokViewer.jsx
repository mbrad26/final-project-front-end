...
class TikTokViewer extends Component {
  ...
  muteVideo() {
    ...
    this.state.muted
      ? (this.state.muteUnmute = "M")
      : (this.state.muteUnmute = "U");
  }
    ...
    return (
      <div className="tik-tok-viewer" data-cy="tik-tok">
        <div className="content">
          <p className="previous" onClick={this.handlePrevious}>
          ...
          <div className="embed-responsive embed-responsive-9by16">
            ...
            <div className="controls">
              <p
                className=" mute top-right"
                onClick={this.muteVideo.bind(this)}
              >
                {this.state.muteUnmute}
              </p>
          ...
          <p className="next" onClick={this.handleNext}>
